                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-8">
                        <div class="slider_text text-center justify-content-center">
                            <p>Amazing Growth Opportunity </p>
                            <h3>Journey With The Right People</h3>
        ...
        <div class="single_slider  d-flex align-items-center slider_bg_6">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-8">
                        <div class="slider_text text-center justify-content-center">
                        <h3>Lectus arcu bibendum </h3>
                            <p>"Lectus arcu bibendum at varius vel pharetra vel. Auctor eu augue ut lectus.
                                Nunc non blandit massa enim nec dui nunc mattis. Ipsum dolor sit amet consectetur adipiscing. 
                                Viverra suspendisse potenti nullam ac tortor vitae purus faucibus ornare. ".</p>
                        </div>
                    </div>
                </div>
            </div>
